...
class ShippingContainer:
    ...
    # This is how we define a getter method in python
...
class RefrigeratedShippingContainer(ShippingContainer):
    ...
    def __init__(self, owner_code, length_ft, contents, *, celsius, **kwargs):
        ...
        # The self.celsius attribute will be set by the setter method
        # We only need to do the check in the setter method this way
    ...
    # Good OOP practice is to not override the properties directly
    # Make regular methods and override those methods in the
    # Child class. So override _set_celsius in the Child class
    @celsius.setter
